...
class ACE_Medical_Defibrillation_AnalysedState : ACE_Medical_Defibrillation_IDefibState
{
	...
	override void OnEnter(ACE_Medical_Defibrillation_DefibContext context)
	{
		...
		{
			context.m_pDefibrillator.PlaySound(ACE_Medical_Defibrillation_SharedSounds.SOUNDSHOCKADVISED);
		...
		else
		{
			...
			context.m_pDefibrillator.PlaySound(ACE_Medical_Defibrillation_SharedSounds.SOUNDNOSHOCKADVISED);
